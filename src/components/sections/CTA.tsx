...
export function CTA() {
  ...
  return (
    <section className="w-full bg-black text-white py-unit-20 md:py-unit-32 relative overflow-hidden dark-grid-bg" id="contacto">
      <div className="max-w-[1280px] mx-auto px-gutter-mobile md:px-gutter-desktop relative z-10">
        <div className="max-w-3xl">
          ...
          <h2 className="text-display-xl-mobile md:text-display-xl tracking-[-0.04em] font-extrabold text-white mb-unit-6 leading-[1.04]">
            {t('cta.title')}
          </h2>
          ...
          <div className="p-6 rounded-2xl bg-neutral-900/90 border border-neutral-800 max-w-xl w-full shadow-2xl backdrop-blur-md">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div className="flex items-start gap-3">
                <span className="material-symbols-outlined text-emerald-400 shrink-0 mt-0.5" style={{ fontSize: '24px' }}>chat</span>
