...
export function Footer() {
  ...
  return (
    <footer className="w-full bg-[#FAF9F7] border-t border-black/[0.08] py-unit-16" role="contentinfo">
      <div className="max-w-[1280px] mx-auto px-gutter-desktop">
        <div className="flex flex-col md:flex-row md:items-start justify-between gap-unit-8 pb-unit-12 border-b border-neutral-200">
          ...
          <nav className="flex flex-wrap items-center gap-x-unit-6 gap-y-unit-3 text-on-surface-variant font-mono text-xs" aria-label="Enlaces del pie de página">
